...
import {
  ...
  useTheme, InputAdornment, styled, FormControl, InputLabel, Select, MenuItem // Import styled, FormControl, InputLabel, Select, MenuItem
} from '@mui/material';
...
import AccessTimeIcon from '@mui/icons-material/AccessTime'; // Para el ícono de zona horaria
import ArrowDropDownIcon from '@mui/icons-material/ArrowDropDown'; // Añadir esta importación

import { useAuth } from '../../context/AuthContext'; // Asegúrate que la ruta sea correcta
import { detectBrowserTimezone, commonTimezones } from '../../utils/dateUtils'; // Usar nuestras utilidades
...
const Register = () => {
  ...
  const [companyData, setCompanyData] = useState({
    ...
    phone: '',
    email: '',
    timezone: detectBrowserTimezone() // Detectar automáticamente
  });
        ...
        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ width: '100%' }}>
          {activeStep === 0 ? (
            ...
            <Grid container spacing={2}>
              ...
              {/* Reemplazar el componente FormControl actual con este: */}
              <Grid item xs={12}>
